...
d3.csv("CLEAN_charity_data.csv", function(data) {
 console.log (data)
 console.log (data.score)
  ...
  var x = d3.scaleBand()
    .range([ 0, width ])
    .domain(["Animals", "Arts, Culture, Humanities", "Community Development", "Education", "Environment", "Health", "Human and Civil Rights", "Human Services", "International", "Research and Public Policy", "Religion"])
    .paddingInner(1)
    .paddingOuter(.5)
  svg.append("g")
